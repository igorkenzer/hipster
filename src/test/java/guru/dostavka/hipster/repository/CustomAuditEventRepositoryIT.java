package guru.dostavka.hipster.repository;

import guru.dostavka.hipster.HipsterApp;

import guru.dostavka.hipster.config.Constants;
import guru.dostavka.hipster.config.audit.AuditEventConverter;
import guru.dostavka.hipster.domain.PersistentAuditEvent;
...
import static guru.dostavka.hipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
